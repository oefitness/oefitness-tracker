...
export const QuickLogModal: React.FC<QuickLogModalProps> = ({
  ...
  const { logFood, userProfile } = useApp();
                ...
                >
                  <div className="space-y-0.5">
                    ...
                    <div className="flex items-center gap-2 text-[11px] text-muted-foreground">
                      ...
                      <span>•</span>
                      <span className="text-sky-600 dark<dyad-write path="src/components/QuickLogModal.tsx" description="Ultra-fast food logging modal with barcode simulator, search, portion adjustment, and direct meal assignment">
import React, { useState } from 'react';
import { FoodItem, MealType } from '@/types/nutrition';
import { MOCK_FOODS } from '@/data/mockData';
import { useApp } from '@/context/AppContext';
